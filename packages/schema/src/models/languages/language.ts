...
export const languageSchema = z
	.object({
		...
		speak: languageProficiencySchema.optional().default("no").register(primaryRegistry, {
			description: "ability to speak using the language",
		}),
		listen: languageProficiencySchema.optional().default("no").register(primaryRegistry, {
			description: "ability to understand speech spoken in the language",
		}),
		write: languageProficiencySchema.optional().default("no").register(primaryRegistry, {
			description: "ability to write using the language",
		}),
		read: languageProficiencySchema.optional().default("no").register(primaryRegistry, {
