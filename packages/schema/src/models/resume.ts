...
export const resumeSchema = z
	.object({
		...
		creations: z.array(epicSchema).optional().default([]).register(primaryRegistry, {
			description: "the creations of a person, which consists of projects under various epics",
		}),
		education: z.array(instituteSchema).optional().default([]).register(primaryRegistry, {
			description:
		...
		skills: z.array(skillSchema).optional().default([]).register(primaryRegistry, {
			description: "a list of skills that the person has",
		}),
		languages: z.array(languageSchema).optional().default([]).register(primaryRegistry, {
