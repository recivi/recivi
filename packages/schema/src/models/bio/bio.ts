...
export const bioSchema = z
	.object({
		...
		aliases: z.array(z.string()).optional().default([]).register(primaryRegistry, {
			description:
		...
		labels: z.array(z.string()).optional().default([]).register(primaryRegistry, {
		...
		profiles: z.array(profileSchema).optional().default([]).register(primaryRegistry, {
