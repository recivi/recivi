...
import { type RoleLocation, roleLocationSchema } from "@/models/work/role_location";
...
export const roleSchema = z
	.object({
		...
		highlights: z.array(z.string()).optional().default([]).register(primaryRegistry, {
		...
		epicIds: z.array(z.string()).optional().default([]).register(primaryRegistry, {
			description:
