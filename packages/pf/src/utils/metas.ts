 ...
 * @returns the list of `<meta>` tag attribute objects
 */
export function getWebsiteMetaTags(frontmatter: z.infer<typeof pageSchema>): MetaTag[] {
	const tags: MetaTag[] = [];
	if (frontmatter.banRobots) tags.push({ name: "robots", content: "noindex, nofollow" });
	return tags;
}
 ...
 * @returns the list of `<meta>` tag attribute objects
 */
export function getArticleMetaTags(frontmatter: z.infer<typeof blogSchema>): MetaTag[] {
	const tags: MetaTag[] = [
